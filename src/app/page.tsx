    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-6">
      <div className="max-w-lg text-center space-y-10">
        <div className="space-y-3">
          <h1 className="text-5xl font-bold tracking-tight text-white">Alina</h1>
        ...
        <div className="grid grid-cols-3 gap-3 text-left">
          <div className="border border-zinc-800/60 rounded-lg p-3.5 space-y-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-white text-zinc-950 text-sm px-5 py-2 rounded-md font-medium hover:bg-zinc-200 transition-colors"
        >
          Open Dashboard
