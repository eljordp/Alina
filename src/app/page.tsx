...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 sm:px-6">
      <div className="max-w-lg text-center space-y-8 sm:space-y-10">
        <div className="space-y-3 animate-fade-in-up">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-zinc-900">Alina</h1>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-zinc-900 text-white text-sm px-5 py-2.5 sm:py-2 rounded-md font-medium hover:bg-zinc-800 hover:gap-3 transition-all animate-fade-in-up delay-400"
        >
          Open Dashboard
