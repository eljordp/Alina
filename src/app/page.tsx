    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6">
      <div className="max-w-lg text-center space-y-10">
        ...
        <div className="grid grid-cols-3 gap-3 text-left">
          <div className="border border-zinc-200 rounded-lg p-3.5 space-y-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-zinc-900 text-white text-sm px-5 py-2 rounded-md font-medium hover:bg-zinc-800 transition-colors"
        >
          Open Dashboard
